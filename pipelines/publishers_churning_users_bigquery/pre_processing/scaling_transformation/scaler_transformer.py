...
class ScalerTransformer:
    ...
    def __init__(self, dask_df):
        ...
        self.num_labels = ['bounces', 'events', 'page_views', 'sessions']
        self.gauss_labels = ['session_duration']
    ...
    def get_transformed_numeric_data(self):
        ...
        for column in self.num_labels:
            ...
            pkl_file = f'{self.models_dir}/{self.day_as_str}_{self.unique_hash}_ga_chp_bq_box_cox_{column}.pkl'
        ...
        pkl_file = f'{self.models_dir}/{self.day_as_str}_{self.unique_hash}_ga_chp_bq_pipeline.pkl'
