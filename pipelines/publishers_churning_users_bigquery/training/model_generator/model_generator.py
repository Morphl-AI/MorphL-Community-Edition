...
class ModelGenerator:
    ...
    def generate_and_save_model(self):
        ...
        churn_scores_json_file = f'{self.models_dir}/{self.day_as_str}_{self.unique_hash}_ga_chp_bq_churn_scores.json'
        with open(churn_scores_json_file, 'w') as writer:
            writer.write(json.dumps(scores))

        # Save the model in a similar way.
        churn_model_file = f'{self.models_dir}/{self.day_as_str}_{self.unique_hash}_ga_chp_bq_churn_model.h5'
