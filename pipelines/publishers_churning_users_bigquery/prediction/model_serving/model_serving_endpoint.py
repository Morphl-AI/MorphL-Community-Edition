...
class Cassandra:
    ...
    def prepare_statements(self):
        ...
        template_for_multiple_rows = 'SELECT client_id, prediction FROM ga_chp_bq_predictions_by_prediction_date WHERE prediction_date = ?'
        template_for_predictions_statistics = 'SELECT loyal, neutral, churning, lost FROM ga_chp_bq_predictions_statistics WHERE prediction_date= ? LIMIT 1'
...
@app.route('/churning-bq/getpredictions', methods=['GET'], defaults={'client_id': None})
@app.route('/churning-bq/getpredictions/<client_id>', methods=['GET'])
...
@app.route('/churning-bq/getpredictionsstatistics', methods=['GET'])
...
@app.route('/churning-bq/getmodelstatistics', methods=['GET'])
